...
## Notes
 ...
 - I have tested this on AWS instances as target instances so I have used ubuntu-user. Please make sure to use appropriate user in "ssh.yml" who has access to target servers and the machine from where you will run Ansible should have passwordless access to target servers.  
